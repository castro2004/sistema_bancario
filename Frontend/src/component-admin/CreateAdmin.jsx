    ...
    <div>
      <div>
        <div className="sidebar">
          ...
          <img src={banco} width={250} alt="Banco" />
          <ul className="nav-links">
            <li>
              ...
              <ul className="sub-menu blank">
                <li>
                  <a className="link_name" href="/createAdmin">
                    Category
                  </a>
                </li>
              </ul>
            ...
            <li>
              ...
              <Link to="/viewData-admin">
                <img src={viewdata_img} width={70} alt="Ver Datos" />
              </Link>
            </li>
            <li>
              ...
              <Link to="/admin/accounts">
                <img src={viewC} width={70} alt="Ver Cuentas" />
              </Link>
            </li>
            <li>
              <a href="/create-user">
              ...
              <Link to="/create-user">
                <img src={agregarU} width={70} alt="Agregar Usuario" />
              </Link>
            </li>
            <li>
              <a href="/createAdmin">
              ...
              <Link to="/createAdmin">
                <img src={agregarA} width={70} alt="Agregar Administrador" />
              </Link>
            </li>
            <li>
              <a href="/menu-admin">
              ...
              <Link to="/menu-admin">
                <img src={menu} width={70} alt="Menú" />
              </Link>
            </li>
            <li>
              <a href="/login-admin">
              ...
              <Link to="/login-admin">
                <img src={CS} width={70} alt="Cerrar Sesión" />
              </Link>
            </li>
          </ul>
        </div>
